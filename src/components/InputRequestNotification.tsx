  ...
  return (
    <>
      ...
      transition-all duration-300 ease-in-out ${
        ...
        >
          <div
            className="bg-gray-800/95 backdrop-blur-sm rounded-xl shadow-2xl border border-gray-700 
        p-8 flex flex-col items-center gap-6 w-[480px]"
          >
            <div className="text-center">
              ...
              <p className="text-lg text-gray-400">
                {isQueueEmpty
                  ...
                  : "Please wait for all messages to be read"}
              </p>
            </div>
            ...
            >
              ...
              <svg
                className={`w-10 h-10 ${
                  isRecording ? "text-white" : "text-gray-100"
                }`}
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
